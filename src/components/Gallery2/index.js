      ...
      <section id="protfolio" className="gallery-section s2 section-padding">
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_2} image={Gallery_2} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_3} image={Gallery_3} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_4} image={Gallery_4} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_5} image={Gallery_5} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_6} image={Gallery_6} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_7} image={Gallery_7} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_8} image={Gallery_8} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_9} image={Gallery_9} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_10} image={Gallery_10} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_11} image={Gallery_11} />
              </div>
            </div>
            <div className="col col-lg-3 col-md-6 col-sm-6 col-12">
              <div className="gallery-img">
                <ReactFancyBox thumbnail={Gallery_12} image={Gallery_12} />
              </div>
            </div>
          </div>
        </div>
